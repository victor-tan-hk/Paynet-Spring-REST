...
public class DeveloperController {
  ...
  public List<DeveloperDTO> getDevelopers(@RequestParam Map<String, String> allParams) {

    log.info("GET /api/developers invoked");
    
    return devService.getWithParams(allParams);
  }
  ...
  public DeveloperDTO getSingleDeveloper(@PathVariable String devIdString) {

    log.info("GET /api/developers/" + devIdString + " invoked");
    ...
    return (devService.getSingleDeveloper(devId));
